...
libradio.a: am.o attr.o audio.o ax25.o bandplan.o display.o doppler.o fcd.o filter.o fm.o gr.o knob.o linear.o misc.o modes.o multicast.o radio.o touch.o
	ar rv $@ $^
	ranlib $@
